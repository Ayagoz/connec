...
plsr_param = {'n_components':[2,3,5,9, 10, 20,40, 50, 70, 80, 99, 120, 150],
...
mean_labels = np.array(mean_labels[0].tolist() + mean_labels[1].tolist())
        

X, Y = get_all_attr(thinkness, log_jac, mesh_area, mean_labels, Y)
